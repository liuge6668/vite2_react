...
const flatConfig = [
  ...
  // React 相关配置项，用于对 React 项目代码进行规范检查和配置
  {
    ...
    rules: {
      ...
      'react/jsx-no-target-blank': 'off' // jsx-no-target-blank 规则
    },
    settings: {
      react: {
...
export default [eslint.configs.recommended, eslintPluginPrettierRecommended, eslintConfigPrettier, ...flatConfig, ...customTsFlatConfig]
